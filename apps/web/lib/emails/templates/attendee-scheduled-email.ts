...
`.trim();
  ...
  protected getEmailText(): string {
    if (
      ...
      <p style="font-weight: 700; line-height: 24px; color: #494949;">📅 Agendar la consulta de seguimiento a la semana en el siguiente link> https://turnos.marchettirules.com/marchettirules/plan-online-consulta-seguimiento-packs</p>
